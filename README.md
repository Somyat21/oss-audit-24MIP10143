...
**Student Name:** Somya Tiwari  
**Registration Number:** 24MIP10143
**Course:** Open Source Software (OSS NGMC)  
**Chosen Software:** Mozilla Firefox  
**Repository:** `oss-audit-24MIP10143`
...
```bash
git clone https://github.com/Somyat21/oss-audit-24MIP10143.git
cd oss-audit-24MIP10143
```
